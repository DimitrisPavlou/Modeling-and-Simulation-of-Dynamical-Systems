function dz = projected_lyapunov_sigma_mod(t, z, A_true, B_true, Ga, Gb, theta_m, u, omega, sigmaA, sigmaB)
    ...
    % Parameter adaptation laws (with sigma modification)
    Ahat_dot = Ga .* (e * x') - Ga .* (sigmaA * Ahat); 
    Bhat_dot = Gb .* (e * u)  - Gb .* (sigmaB * Bhat); 
    %apply projection
    lb_A = [-3, -Inf; -Inf, -Inf];
    ub_A = [-1, Inf; Inf, Inf]; 
